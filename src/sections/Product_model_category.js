  ...
  return (
    <>
      <div className='container-xxl'>
        ...
        <div class="col"><div className='mb-4 category-header'>Latest Product</div>
          {itemsFirst.map(products => <ModelItem2 key={products._id} item={products}/>)}
        </div>
        <div class="col"><div className='mb-4 category-header'>Best Selling Product</div>
          {itemsMid.map(products => <ModelItem2 key={products._id} item={products}/>)}
        </div>
        <div class="col"><div className='mb-4 category-header'>Top Rated Product</div>
